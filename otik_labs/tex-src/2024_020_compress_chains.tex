...
\section{RLE: подсемейство «наивный RLE» [RLE-н]}
...
\section{RLE: подсемейство «RLE с~флаг-битом» [RLE-фб]}
...
\termin{Скользящее окно:} область перед текущей позицией кодирования, в~которой можем искать \termin{начало} предыдущего вхождения слова (конец слова м.\,б.\,вне окна) и~адресовать %($w \leqslant \max(S)$) 
...
\subsection{Схема данных кодирования методом LZ77 (общая)}
\begin{frame}[plain]{\insertsubsection}
% \begin{frame}{\insertsubsection}
\begin{adjustwidth}{-7em}{-7em}
...
\subsection{Схема данных кодирования LZ77 (подробная; слова в~окне "--- отдельная структура)}
% \begin{frame}[plain]{\insertsubsection}
\begin{frame}{\insertsubsection}
\begin{adjustwidth}{-7em}{-7em}
% \includegraphics[width=\linewidth]{\IMGPATH/data_lz77}
\includegraphics[width=\linewidth]{\IMGPATH/data_lz77_encode_dict_v2}
\end{adjustwidth}
\end{frame}
